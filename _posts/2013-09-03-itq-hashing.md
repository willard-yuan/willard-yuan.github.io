...
![itq_hashing](http://yongyuan.name/imgs/posts/itq_hashing.png)
...
![itq_airplane](http://yongyuan.name/imgs/posts/itq_airplane.png)

Yunchao Gong Homepage上公开了Matlab源码，不过并不提供数据库，直接运行不了，小白菜已经对源码进行了modify，有需要的可以看LSH、ITQ、SKLSH图像检索实验实现(Code)这篇文章，在这篇文章中提供了modified后的代码，也可以直接到小白菜的GitHub主页上下载[hashing-baseline-for-image-retrieval](https://github.com/willard-yuan/hashing-baseline-for-image-retrieval)，其中有ITQ的代码。
